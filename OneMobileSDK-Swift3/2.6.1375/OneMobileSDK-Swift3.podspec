...
"
  ...
  Checkout https://github.com/vidible/OneMobileSDK-playground-ios for up-to-date examples.
                       DESC
  ...
  s.source           = {
    :http => "https://github.com/vidible/OneMobileSDK-releases/releases/download/2.6/OneMobileSDK.framework.zip"
  }
